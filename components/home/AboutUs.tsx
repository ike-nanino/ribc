...
function AboutUs() {
    return (
        <section className='my-10'>
            ...
            <div className='flex flex-col gap-10 px-10 max-w-4xl'>
                ...
                <p>
                The management team is headed by our President & CEO Mr. Manish Mishra, who is supported by a team of senior leaders with oversight functions in credit management, risk management, legislative compliance, operations, financial control, audit, IT, HR and business development.
                </p>
            </div>
        </section>
    )
